...
export default function AddThreadDialog({ open, onClose, onConfirm }: AddThreadProps): ReactNode {
    ...
    return (
        <div
            className="fixed inset-0 z-[1000] flex items-center justify-center bg-base-content/70 p-4 backdrop-blur-sm"
            onClick={onClose_}
        >
            <div
            ...
            >
                <h2 className="text-center text-lg font-semibold">Add a New Thread</h2>
                <input
                    type="text"
                    placeholder="Title"
                    value={title}
